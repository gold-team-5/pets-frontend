      ...
      <body>
        ...
        <div className='homecads' >
          ...
          <Card className="carthome" >
            <Card.Img className="imghome" variant="top" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVp_3v2cAzZ5bAwawLniLNz9j7ABHVPyMkBg&usqp=CAU' />
            <Card.Body>
          ...
          <Card className="carthome" >
            <Card.Img  className="imghome"  variant="top" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIew5f5gVc8Gd8n9zu87acY-YS3hN9BkfCyA&usqp=CAU' />
            <Card.Body>
          ...
          <Card  className="carthome" >
            <Card.Img  className="imghome"  variant="top" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5ps8TZRyIWb6SoQdrElDc0BWnkwI9p0TiSQ&usqp=CAU' />
            <Card.Body>
              <Card.Title></Card.Title>
              <Card.Text >
          ...
          <Card className="carthome" >
            <Card.Img className="imghome"     variant="top" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyC6rf-VDqrZDKKq0X7JmHrtz7xJjEV5ITGQ&usqp=CAU' />
            <Card.Body>
              <Card.Title></Card.Title>
              <Card.Text >
